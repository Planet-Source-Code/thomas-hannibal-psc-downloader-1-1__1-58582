...
'**************************************
' Name: A Basic Set of File handling con
'     trols (updated)
' Description:FileReal, CloseAllFiles, C
'     opyFile, DeleteFile, GetAttrib, GetFileD
'     ate, GetFileExtension, GetFileSize, Make
'     DIR, RemoveDIR, SetHidden, SetReadOnly,
'     SetSystem, SetNormal, Overwrite
' By: Sam Truscott
'
' Inputs:Filename, Path, Source, Destina
'     tion
'
' Returns:Filesize, File attributes, Fil
'     e Date/Time, File extension
'
'This code is copyrighted and has' limited warranties.Please see http://w
'     ww.Planet-Source-Code.com/vb/scripts/Sho
'     wCode.asp?txtCodeId=21513&lngWId=1'for details.'**************************************
...
Public Sub Save(FileName As String)
    ...
    If FileReal(FileName) = True Then
